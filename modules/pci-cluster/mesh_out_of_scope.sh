...
gcloud container clusters get-credentials out-of-scope \
    --region us-central1 \
...
gcloud container fleet memberships register out-of-scope-membership \
  --gke-uri=https://container.googleapis.com/v1/projects/pci-refresh-test-7c56/locations/us-central1/clusters/out-of-scope \
...
gcloud container clusters update  --project pci-refresh-test-7c56 out-of-scope \
  --region us-central1 --update-labels mesh_id=proj-pci-refresh-test-7c56

# Enable automatic management
gcloud container fleet mesh update \
     --management automatic \
     --memberships out-of-scope-membership \
     --project pci-refresh-test-7c56
